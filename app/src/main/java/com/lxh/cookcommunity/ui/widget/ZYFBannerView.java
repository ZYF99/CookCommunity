...
public class ZYFBannerView<T> extends RelativeLayout {
    private static final String TAG = "MZBannerView";
    private CustomViewPager mViewPager;
    private com.zhouwei.mzbanner.MZBannerView.MZPagerAdapter mAdapter;
    ...
    private com.zhouwei.mzbanner.MZBannerView.ViewPagerScroller mViewPagerScroller;//控制ViewPager滑动速度的Scroller
    ...
    private com.zhouwei.mzbanner.MZBannerView.BannerPageClickListener mBannerPageClickListener;
    ...
    public ZYFBannerView(@NonNull Context context) {
        super(context);
        init();
    }

    public ZYFBannerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        readAttrs(context,attrs);
        init();
    }

    public ZYFBannerView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public ZYFBannerView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void readAttrs(Context context, AttributeSet attrs){
        ...
        mIndicatorAlign = typedArray.getInt(R.styleable.MZBannerView_indicatorAlign, com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.CENTER.ordinal());
    ...
    private void sureIndicatorPosition(){
        if(mIndicatorAlign == com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.LEFT.ordinal()){
            setIndicatorAlign(com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.LEFT);
        }else if(mIndicatorAlign == com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.CENTER.ordinal()){
            setIndicatorAlign(com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.CENTER);
        }else{
            setIndicatorAlign(com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.RIGHT);
        }
    }
    ...
    private void initViewPagerScroll() {
        try {
            ...
            mViewPagerScroller = new com.zhouwei.mzbanner.MZBannerView.ViewPagerScroller(
    ...
    private void initIndicator(){
        ...
        for(int i=0;i<mDatas.size();i++){
            ...
            }else if(mIndicatorAlign == com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.RIGHT.ordinal()){
                if(i == mDatas.size() - 1){
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link com.zhouwei.mzbanner.MZBannerView {@link #setPages(List, MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
    ...
    /**
     *  添加Page点击事件
     * @param bannerPageClickListener {@link com.zhouwei.mzbanner.MZBannerView.BannerPageClickListener}
     */
    public void setBannerPageClickListener(com.zhouwei.mzbanner.MZBannerView.BannerPageClickListener bannerPageClickListener) {
    ...
    public void setPages(List<T> datas, MZHolderCreator mzHolderCreator){
        ...
        mAdapter = new com.zhouwei.mzbanner.MZBannerView.MZPagerAdapter(datas,mzHolderCreator,mIsCanLoop);
    ...
    /**
     * 设置Indicator 的对齐方式
     * @param indicatorAlign {@link com.zhouwei.mzbanner.MZBannerView.IndicatorAlign#CENTER }{@link com.zhouwei.mzbanner.MZBannerView.IndicatorAlign#LEFT }{@link com.zhouwei.mzbanner.MZBannerView.IndicatorAlign#RIGHT }
     */
    public void setIndicatorAlign(com.zhouwei.mzbanner.MZBannerView.IndicatorAlign indicatorAlign) {
        mIndicatorAlign = indicatorAlign.ordinal();
        LayoutParams layoutParams = (LayoutParams) mIndicatorContainer.getLayoutParams();
        if(indicatorAlign == com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.LEFT){
            layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        }else if(indicatorAlign == com.zhouwei.mzbanner.MZBannerView.IndicatorAlign.RIGHT){
    ...
    public static class  MZPagerAdapter<T> extends PagerAdapter {
        ...
        private com.zhouwei.mzbanner.MZBannerView.BannerPageClickListener mPageClickListener;
        ...
        public void setPageClickListener(com.zhouwei.mzbanner.MZBannerView.BannerPageClickListener pageClickListener) {
